...
<head>
  ...
  <link rel="stylesheet" href="wireframe1.css"> </head>
...
<nav class="navbar navbar-expand-lg navbar-light bg-dark">
    ...
    <span class="navbar-toggler-icon"></span>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<div class="btn-group col-6" role="group" aria-label="Basic example">
				...
				<button type="button" class="btn btn-secondary" onClick="ShowFavourite()">Show Favorites</button>
    ...
    <div class="container-fluid bg-info">
      <div class="row">
        <div class="mx-auto text-center col-md-6">
          ...
          <p class="lead text-primary">Movie Mania is a wonderful app to catch all the hollywood and bollywood movies at a single place and watch their trailers to have a glimpse of the movie. If you are a movie maniac, then you are at the right place.</p>
        </div> 
      </div>
       <div class="mx-auto text-center col-md-6">
            <div id="imaginary_container"> 
                <div class="input-group stylish-input-group">
                    <input id="usertext" type="text" class="form-control"  placeholder="Search Movie" >
                    <span class="input-group-addon">
                         <button class="btn btn-link my-2 my-sm-0" type="submit" onClick="getData()"><i class="fa d-inline fa-lg fa-search text-primary"></i></button>
                    </span>
  ...
  <div id="favoritesadded">Alert if fav is added
  </div>
  <div class="py-5 bg-primary">
    <div class="container">
      <div id="cardcontainerformovie" class="row">   
      </div>
            ...
            <div class="carousel-inner bg-light" role="listbox">
              <div class="carousel-item p-5 active">
                <div class="blockquote text-muted mb-0 px-2">
                  <p class="mb-0">#1 Blockquoute - Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.</p>
